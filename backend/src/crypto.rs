...
/// Encrypt TOTP secret with password (OLD METHOD - DEPRECATED)
#[deprecated(note = "Use encrypt_totp_secret_secure with random key instead")]
...
#[deprecated(note = "Use decrypt_totp_secret_secure with random key instead")]
...
/// Derive a consistent password hash for wrapping encryption keys
/// This is NOT used to encrypt user data directly anymore
